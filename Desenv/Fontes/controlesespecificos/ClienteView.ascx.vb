...
Partial Public Class ClienteView
    ...
    Private Sub txtCPF_CNPJ_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCPF_CNPJ.TextChanged
        Dim sCNPJ As String = DirectCast(sender, TextBox).Text.Trim
        If sCNPJ.Length > 0 Then
            Dim cn As New Cliente.ctlCliente
            Dim dt As DataTable
            dt = cn.Pesquisar(CType(Cliente.ctlCliente.TipoPesquisa.CPF_CNPJ, Cliente.ctlCliente.TipoPesquisa), sCNPJ.ToString)
            lblNome.Text = ""
            txtCodigo.Text = ""
            txtLoja.Text = ""
            lblFound.Text = (False).ToString
