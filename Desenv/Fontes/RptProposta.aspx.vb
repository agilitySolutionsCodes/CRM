...
Public Class RptProposta
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim reader = cn.SelecionarUsuarioID()

            If reader.Rows.Count > 0 Then

                'Cabeçalho
                sCNPJ = reader.Rows(0)("CPFCNPJ").ToString.Trim
                ...
                'lblInscricaoEstadual.Text = reader.rows(0)("InscricaoEstadual").ToString.Trim

                'Rodapé
                lblRazaoSocial.Text = reader.Rows(0)("NOME").ToString
                Dim texto As String = ""
                Dim endereco As String = reader.Rows(0)("Endereco").ToString.Trim()
                Dim cep As String = reader.Rows(0)("CEP").ToString.Trim
                Dim telefone As String = reader.Rows(0)("Telefone").ToString.Trim
                Dim fax As String = reader.Rows(0)("Fax").ToString.Trim
                Dim cidade As String = reader.Rows(0)("Cidade").ToString.Trim
                Dim uf As String = reader.Rows(0)("UF").ToString.Trim
                ...
                'Assinatura
                If Not String.IsNullOrEmpty(reader.Rows(0)("NOME").ToString.Trim) Then
                    lblRazaoSocial2.Text = reader.Rows(0)("NOME").ToString
                ...
                End If
                lblEmail.Text = reader.Rows(0)("Email").ToString
