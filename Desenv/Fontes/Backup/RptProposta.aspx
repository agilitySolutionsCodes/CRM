        ...
        <tr>
            ...
            <td  class="style2">
                <asp:Image ID="imgLogoIntermed" runat="server" Height="52px" 
                    ImageUrl="~/App_Themes/Intermed/Logo.png" /> &nbsp;
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td  class="style2" colspan="2">
                CNPJ: <asp:Label ID="lblCNPJIntermed" runat="server" Text="49.520.521/0001-69" />
            </td>
        </tr>
    </table> <hr />

    <asp:Panel ID="pnlCorpo" runat="server" CssClass="conteudo"> <br/>
        
        <b>Proposta: </b> <asp:Label ID="lblProposta" runat="server" /> <br/> <br/>
        <asp:Label ID="lblLocal" runat="server" Text="São Paulo" CssClass="texto" />
        ,
        <asp:Label ID="lblDataEmissao" runat="server"/> <br/> <br/>
        Para: <asp:Label ID="lblNomeCliente" runat="server" CssClass="texto" /> <br/> 
        <asp:Label ID="lblCnpjCliente" runat="server" /> <br/>
        <asp:Label ID="lblEnderecoCliente" runat="server" CssClass="texto" /> <br/>
        <asp:Label ID="lblMunicipioCliente" runat="server" CssClass="texto" /> &nbsp;
        <asp:Label ID="lblUFCliente" runat="server" /> <br/>
        <asp:Label ID="lblTitContato" runat="server" Text="A.C.:" /> &nbsp;
        <asp:Label ID="lblContato" runat="server" CssClass="texto" /> &nbsp; <br/> <br/>
        ...
        OBSERVAÇÃO: <br/>
        O valor total para pedido e faturamento mínimo não deverá ser inferior a R$ 250,00 (Duzentos e Cinqüenta Reais). <br/> <br/>
        ...
        os plugues e tomadas para rede elétrica deverão atender a norma em questão. <br/>
        Informamos que os produtos Intermed já estão aderentes a norma vigente e pedimos a
        nossos clientes que providenciem as adequações necessárias. <br/> <br/>
        ...
        contraria o disposto na Resolução-ANVISA RDC n° 59/2000 e a orientação contida no Manual de Operação do Produto. <br/> <br/>

        A garantia não cobre defeitos causados por acidente, uso inadequado, condições de uso, instalação ou esterilização inadequadas, serviço, instalação, operação ou alteração realizados por pessoal não autorizado ou desqualificado. <br/>
        Peças sujeitas a desgaste ou deterioração normal pelo uso, condições de uso adversas, uso inadvertido ou acidentes não são cobertas pela GARANTIA. <br/> <br/>
        ...
        <asp:Label ID="lblDetCondicao" runat="server" CssClass="texto"/> <br/>
        <b>Frete: </b>
        <asp:Label ID="lblFrete" runat="server" /> <br />
        <asp:Label ID="lblValidade" runat="server" Style="font-weight: 700" /> <br/> <br/>

        <!-- <asp:Panel ID="pnlObservacao" runat="server" Visible="false" >
            <asp:Label ID="lblTitObservacao" runat="server" Font-Bold="True">Observação na proposta:</asp:Label><br />
       ...
       <asp:Label ID="lblTextoObservacao" runat="server"> ** O prazo de entrega terá validade a partir da data de aprovação desta proposta. <br/>
            **** Em caso de aprovação da proposta, é necessário que a mesma seja realizada através de fax ou e-mail citados abaixo. </asp:Label> <br /> <br />
       ...
       <asp:Panel ID="pnlFaturadoPelaIntermed" runat="server" Visible="true" > 
            <asp:Label ID="lblFaturadoPelaIntermed" runat="server" Font-Bold="True" >Os itens cotados serão faturados diretamente pela fábrica:</asp:Label><br />
                <asp:Label ID="Label1" runat="server">Intermed Equip. Médico Hosp. Ltda. </asp:Label> <br/>
                <asp:Label ID="Label2" runat="server">R. Santa Mônica, 980 - Pq. Industrial San Jose</asp:Label> &nbsp;- CEP:
                <asp:Label ID="Label3" runat="server">06715-865</asp:Label> - Tel.
                <asp:Label ID="Label6" runat="server">(55)(11) 4615-9300</asp:Label> &nbsp; &nbsp;-
                <asp:Label ID="Label8" runat="server">Cotia</asp:Label> -
                <asp:Label ID="Label9" runat="server">SP</asp:Label> <br/> <br/>
        </asp:Panel>
                ...
                <asp:TemplateField HeaderText="Produto">
                    <ItemTemplate> <br/> <b>
                        <uc1:ProdutoBox ID="oProduto" runat="server" Codigo='<%# Bind("CodigoProduto") %>'
                            Nome='<%# Bind("NomeProduto") %>' /> </b> <br/>
                        <asp:Image ID="imgProduto" runat="server" ImageUrl="~/imagens/pixel.png"/> <br/>
                        <asp:Label ID="lblGarantia" runat="server" Text="" /> <br/> <br/>
                    </ItemTemplate>
                    <FooterStyle HorizontalAlign="Left" />
                    <HeaderStyle HorizontalAlign="Left" />
                    <ItemStyle HorizontalAlign="Left"  />
