...
Public Class clsSeguranca
    ...
    End Function
    Public Shared Function Autenticar(ByVal sUsername As String, ByVal sPassword As String) As WSUserAgility.VALIDASTRUCT
        Dim oWs As New WSUserAgility.WSUSERAGILITY
        Dim oToken As New WSUserAgility.TKNSTRUCT
        Dim oAuth As New WSUserAgility.VALIDASTRUCT

        If Util.GetAmbiente().ToUpper = "DESENV" Then
            Dim oWsD As New WSUserAgility.WSUSERAGILITY
            Dim oTokenD As New WSUserAgility.TKNSTRUCT
            Dim oAuthD As New WSUserAgility.VALIDASTRUCT
            oTokenD.CONTEUDO = sUsername
            oTokenD.SENHA = sPassword


            oAuthD = oWsD.AUTENTICAR(oTokenD)
            oAuth.RETORNO = New WSUserAgility.RETSTRUCT
            ...
            oAuth.USUARIO = New WSUserAgility.USUARIOSTRUCT
            ...
            oAuth.USUARIO.TOKEN = New WSUserAgility.TKNSTRUCT
